...
public class YouseeCustomActivity extends AppCompatActivity implements UsesLoginFeature, OnResponseRecievedListener
{
	...
	private void setMenuState(boolean loggedIn)
	{
		...
		/*
		MenuItem loginMenu = menu.findItem(R.id.defult_menu);
